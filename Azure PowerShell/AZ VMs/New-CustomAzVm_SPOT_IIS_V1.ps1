...
function New-CustomAz-IISVM {
    ...
    if (Get-AzVm -Name $VmName -ResourceGroupName $ResourceGroupName -ErrorAction Ignore) {
        ...
        if (-not(Get-AzVM -Name $vm.Name)){
            ...
            Get-AzPublicIpAddress -Name $vm.Name -ResourceGroupName $ResourceGroupName
            ...
            #Set-AzVMExtension -ExtensionName "IIS" -ResourceGroupName $ResourceGroupName -VMName $vm.Name `
